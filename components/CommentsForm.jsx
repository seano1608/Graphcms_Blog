    ...
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div className="">
          ...
          <label
            ...
            htmlFor="storeData"
          >
            Save my E-mail and name for next comment
          </label>
        </div>
      </div>
      ...
      <div className="mt-8">
        <button
          ...
          className="transition duration-400 ease hover:bg-indigo-900 inline-block bg-pink-600 text-lg rounded-full text-white px-8 py-3 cursor-pointer"
        >
          Post Button
        </button>
        {showSuccessMessage && (
